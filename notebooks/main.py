...
bg_path = os.path.join(BASE_DIR, "assets", "old_paper.jpg")
set_background_local(bg_path)
...
@st.cache_resource
def load_model():
    model_path = os.path.join(BASE_DIR, "outputs", "batik_classification_model.keras")
    return tf.keras.models.load_model(model_path)

@st.cache_resource
def load_class_names():
    class_path = os.path.join(BASE_DIR, "outputs", "class_names.npy")
    return np.load(class_path)
